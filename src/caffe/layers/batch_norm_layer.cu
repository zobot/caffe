...
void BatchNormLayer<Dtype>::Forward_gpu(const vector<Blob<Dtype>*>& bottom,
  ...
  //caffe_gpu_set(mean_.count(), static_cast<Dtype>(0), mean_.mutable_gpu_data());
  //caffe_gpu_set(variance_.count(), static_cast<Dtype>(0), variance_.mutable_gpu_data());
  //Blob<Dtype> var_dup(num,channels,1,1);
//  for (int n = 0; n < num; ++n) {
//    caffe_gpu_gemv<Dtype>(CblasNoTrans, channels, spatial_dim, 1. / (num * spatial_dim),
//        bottom_data + bottom[0]->offset(n),
//        sum_multiplier_.gpu_data(), 1., mean_.mutable_gpu_data());
//    caffe_gpu_gemv<Dtype>(CblasNoTrans, channels, spatial_dim, 1. / (num * spatial_dim),
//        temp_.gpu_data() + temp_.offset(n), sum_multiplier_.gpu_data(), 1.,
//        variance_.mutable_gpu_data());
//  }
  if(use_global_stats_){
    //TODO: should react to reshape
    caffe_copy(mean_.count(),this->blobs_[0]->gpu_data(),mean_.mutable_gpu_data());
    caffe_gpu_scal(mean_.count(),Dtype(1)/this->blobs_[2]->cpu_data()[0],mean_.mutable_gpu_data());
    caffe_copy(variance_.count(),this->blobs_[1]->gpu_data(),variance_.mutable_gpu_data());
    caffe_gpu_scal(variance_.count(),Dtype(1)/this->blobs_[2]->cpu_data()[0],variance_.mutable_gpu_data());
  }else{
    caffe_gpu_gemv<Dtype>(CblasNoTrans, channels*num, spatial_dim, 1. / (num * spatial_dim),
      bottom_data,
    ...
    caffe_gpu_gemv<Dtype>(CblasTrans, num, channels, 1.,
      num_by_chans_.gpu_data(),num_sum_.gpu_data(),0., variance_.mutable_gpu_data());
    //LOG(INFO) << "2)....................... moving_average_fraction .................................\n.......................................";
    //LOG(INFO) << moving_average_fraction_;
    caffe_gpu_scal(mean_.count(),moving_average_fraction_,this->blobs_[0]->mutable_gpu_data());
    caffe_gpu_scal(mean_.count(),moving_average_fraction_,this->blobs_[1]->mutable_gpu_data());
    this->blobs_[2]->mutable_cpu_data()[0]*=moving_average_fraction_;
    this->blobs_[2]->mutable_cpu_data()[0]+=1;
    caffe_gpu_add(mean_.count(),mean_.gpu_data(),this->blobs_[0]->gpu_data(),this->blobs_[0]->mutable_gpu_data());
    caffe_gpu_add(mean_.count(),variance_.gpu_data(),this->blobs_[1]->gpu_data(),this->blobs_[1]->mutable_gpu_data());
  }
  //LOG(INFO)<<"batch_norm_mean:"<<mean_.cpu_data()[0];
...
//        mean_.gpu_data(), sum_multiplier_.gpu_data(), 1., top_data + top[0]->offset(n));
//
//    caffe_gpu_gemm<Dtype>(CblasNoTrans, CblasNoTrans, channels, spatial_dim, 1, 1.,
//          variance_.gpu_data(), sum_multiplier_.gpu_data(), 0.,
//          temp_.mutable_gpu_data() + temp_.offset(n));
//  }
...
void BatchNormLayer<Dtype>::Backward_gpu(const vector<Blob<Dtype>*>& top,
  ...
  //caffe_gpu_set(mean_.count(), static_cast<Dtype>(0), mean_.mutable_gpu_data());
//  for (int n = 0; n < num; ++n) {
//    caffe_gpu_gemv<Dtype>(CblasNoTrans, channels, spatial_dim, 1.,
...
//  caffe_gpu_powx(variance_.count(),variance_.gpu_data(),Dtype(-1),variance_.mutable_gpu_diff());
//  caffe_gpu_add_scalar(variance_.count(),Dtype(-1),variance_.mutable_gpu_diff());
//  caffe_gpu_div(variance_.count(),variance_.gpu_diff(),variance_.gpu_data(),variance_.mutable_gpu_diff());
//  //caffe_gpu_axpy(variance_.count(),Dtype(-1),variance_.gpu_data(),variance_.mutable_gpu_diff());
//  caffe_gpu_axpy(variance_.count(),Dtype(eps),variance_.gpu_diff(),mean_.mutable_gpu_data());
